...
function validateMessage(content, tokenAmount) {
    ...
    const containsProfanity = profanityList.some(word => content.toLowerCase().includes(word.toLowerCase()));
    ...
    const hasPositiveContent = positiveWords.some(word => content.toLowerCase().includes(word.toLowerCase()));
