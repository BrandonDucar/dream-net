 ...
 */
export function autoOptimizeContent(contentType, contentId, title, description, platform = "web", userLocation) {
    // 1. Auto-optimize with SEO
    const seoOptimization = AISEOCore.optimizeContent(contentType, contentId, platform, title, description);
 ...
 */
export function extractLocationFromRequest(req) {
    const location = {};
 ...
 */
export function autoOptimizeDream(dreamId, title, description, userLocation) {
    return autoOptimizeContent("post", dreamId, title, description, "web", userLocation);
}
/**
 * Auto-optimize social post
 */
export function autoOptimizeSocialPost(postId, platform, text, userLocation) {
    return autoOptimizeContent("post", postId, platform, text, text, userLocation);
}
/**
 * Auto-optimize product
 */
export function autoOptimizeProduct(productId, name, description, platform = "web", userLocation) {
