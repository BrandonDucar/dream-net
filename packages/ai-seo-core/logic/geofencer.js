 ...
 * Create a geofence
 */
export function createGeofence(name, type, options) {
    const now = Date.now();
    const geofence = {
        id: nextGeofenceId(),
        name,
 ...
 */
export function applyGeofenceRules(geofenceIds, contentType, platform) {
 ...
 */
export function createGeofenceRule(geofenceId, action, options) {
    const rule = {
        id: nextRuleId(),
        geofenceId,
        action,
 ...
 */
export function ensureDefaultGeofences() {
