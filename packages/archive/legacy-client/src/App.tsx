...
import DreamNetInk from '@/pages/marketing/DreamNetInk';
import DreamNetLive from '@/pages/dashboard/DreamNetLive';
                                ...
                                <div className="dark">
                                    ...
                                    <Suspense fallback={<div className="h-screen w-full bg-black flex items-center justify-center text-white font-mono tracking-widest uppercase">Initializing Sovereign Grid...</div>}>
                                        <Switch>
                                            ...
                                            {domain === 'ink' && <Route path="/" component={DreamNetInk} />}
                                            {domain === 'live' && (
                                                <>
                                                    <MetabolicOverlay />
                                                    <Route path="/" component={DreamNetLive} />
                                                </>
                                            )}
                                            ...
                                            {/* Default/Hub Routing */}
                                            <Route path="/" component={DreamNetInk} />
