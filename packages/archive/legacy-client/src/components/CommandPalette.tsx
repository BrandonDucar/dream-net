...
// Mock dreams data inline to avoid missing file issues
interface MockDream {
  dreamId: string;
  title: string;
  description: string;
...
const mockDreams: MockDream[] = [
  {
    ...
    description: "A dream about quantum entanglement and collective consciousness",
    timestamp: "2026-01-28T10:30:00Z",
    tags: ["quantum", "consciousness", "collective"]
  },
  {
    dreamId: "dream-002", 
    title: "Biological Architecture",
    description: "Visions of biomimetic systems and organ-based computing",
    timestamp: "2026-01-28T09:15:00Z",
    tags: ["biomimetic", "architecture", "organic"]
  },
  {
    dreamId: "dream-003",
    title: "Swarm Intelligence",
    description: "Crab-inspired swarm coordination and emergent behavior",
    timestamp: "2026-01-28T08:45:00Z", 
    tags: ["swarm", "carcinization", "intelligence"]
  }
];
