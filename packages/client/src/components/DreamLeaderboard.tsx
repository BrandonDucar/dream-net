        ...
        <div className="flex gap-2">
          <button
            ...
            className={`px-4 py-2 rounded text-sm ${
              view === 'wallets' ? 'bg-cyan-600 text-white' : 'bg-zinc-700 text-zinc-300'
            }`}
          >
            👑 Top Wallets
          </button>
          <button
            ...
            className={`px-4 py-2 rounded text-sm ${
              view === 'dreams' ? 'bg-cyan-600 text-white' : 'bg-zinc-700 text-zinc-300'
            }`}
          >
            🌟 Top Dreams
          </button>
          ...
          {data.leaderboard.map((entry, index) => (
            <div key={entry.wallet} className="bg-zinc-800 p-4 rounded border border-zinc-700 flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="font-medium text-white">{entry.wallet}</div>
