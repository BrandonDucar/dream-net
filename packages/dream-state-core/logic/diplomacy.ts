import { DreamStateContext, DiplomaticRelation } from "../types";
 ...
 */
export function establishDiplomaticRelation(
  ctx: DreamStateContext,
  protocolName: string,
    ...
    try {
      ...
      if (!existingLead) {
        ...
        recordGovernmentAction(
          "diplomatic",
          "dept:diplomacy",
          `Initiated diplomatic outreach to ${protocolName} via Wolf Pack`,
          { relationId, leadId }
        );
  ...
  recordGovernmentAction(
    "diplomatic",
    "dept:diplomacy",
    `Established diplomatic relation with ${protocolName}`,
    { relationId, protocolType }
  );
 ...
 */
export function upgradeDiplomaticStatus(
  relationId: string,
  ...
  if (success) {
    recordGovernmentAction(
      "diplomatic",
      "dept:diplomacy",
      `Upgraded diplomatic status with ${relation.protocolName}: ${oldStatus} → ${newStatus}`,
      { relationId, oldStatus, newStatus }
    );
  }
 ...
 */
export function ensureDefaultDiplomaticRelations(
  ctx: DreamStateContext
): DiplomaticRelation[] {
  ...
  relations.push(
    establishDiplomaticRelation(
      ...
      "chain",
      undefined,
      "Primary blockchain territory of Dream State"
    )
  );
  ...
  relations.push(
    establishDiplomaticRelation(
      ...
      "chain",
      undefined,
      "Parent chain, foundational relationship"
    )
  );
  ...
  relations.push(
    establishDiplomaticRelation(
      ...
      "chain",
      undefined,
      "Sister L2, potential collaboration"
    )
  );
