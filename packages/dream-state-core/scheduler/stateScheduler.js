 ...
 */
export function runDreamStateCycle(ctx) {
    const now = Date.now();
    ...
    recordGovernmentAction("administrative", "dept:executive", "Dream State heartbeat cycle completed", { timestamp: now, passportCount: CitizenshipStore.status().passportCount });
