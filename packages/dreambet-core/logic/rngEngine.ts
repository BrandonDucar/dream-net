...
export function generateRNG(req: RNGRequest): RNGResult {
 ...
 */
export function rngToUnit(resultHex: string): number {
 ...
 */
export function rngToInt(resultHex: string, n: number): number {
  if (n <= 0) return 0;
