...
class PolicyEngine {
  ...
  private calculateRiskScore(
    ...
    // Tier-based risk
    if (tierId === "SEED") risk += 30;
    else if (tierId === "BUILDER") risk += 15;
    else if (tierId === "OPERATOR") risk += 5;
    else if (tierId === "GOD_MODE") risk += 0;

    // Cluster-based risk
    if (clusterId === "SHIELD_CORE") risk += 20;
    else if (clusterId === "DREAM_STATE") risk += 15;
    else if (clusterId === "WOLF_PACK") risk += 10;
