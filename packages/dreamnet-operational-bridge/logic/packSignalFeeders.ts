...
import type { ScalingMetrics } from "@dreamnet/dreamnet-metrics-core";
import type { CostSummary } from "@dreamnet/dreamnet-cost-core";

/**
 * Feed cost metrics to Wolf Pack (funding decisions)
 */
export function feedCostMetricsToWolfPack(costSummary: CostSummary): void {
 ...
 */
export function feedPerformanceMetricsToWhalePack(metrics: ScalingMetrics): void {
  const signal = {
