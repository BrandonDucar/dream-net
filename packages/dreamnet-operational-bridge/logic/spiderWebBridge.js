 ...
 */
export function operationalEventToThread(event) {
 ...
 * Bridge operational event to Spider Web AND route to Voice (SMS)
 */
export function bridgeToSpiderWeb(event) {
    ...
    if (globalObj.DreamNetVoiceTwilio?.routeEvent) {
        try {
            globalObj.DreamNetVoiceTwilio.routeEvent(event).catch((err) => {
...
//# sourceMappingURL=spiderWebBridge.js.map