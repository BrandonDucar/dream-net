 ...
 */
export function formatWolfPackWin(event) {
 ...
 */
export function formatShieldThreat(event) {
 ...
 */
export function formatHealthFailure(event) {
 ...
 */
export function formatKillSwitch(event) {
 ...
 */
export function formatIncident(event) {
 ...
 */
export function formatCostAlert(event) {
    const cluster = event.clusterId || "unknown";
 ...
 */
export function formatAutoScale(event) {
    const cluster = event.clusterId || "unknown";
 ...
 */
export function formatDefault(event) {
 ...
 */
export function formatEventToSMS(event) {
