 ...
 */
export const DREAMSTATE = DREAMSTATE_BOOTSTRAP;
/**
 ...
 */
export function getPassportByWallet(wallet) {
 ...
 * @returns Passport if found, undefined otherwise
 */
export function getPassportByCitizenId(citizenId) {
 ...
 */
export function getOfficesForCitizen(citizenId) {
 ...
 */
export function getCabinetsForCitizen(citizenId) {
    const passport = getPassportByCitizenId(citizenId);
    if (!passport)
        return [];
