...
import { applyFieldDecay } from "../logic/fieldDecay";
import { updateFieldsFromReputation, updateFieldsFromStarBridge, updateFieldsFromQAL, updateFieldsFromDreamCortex, updateFieldsFromWolfPackAndPSL, } from "../logic/fieldUpdaters";
export function runFieldCycle(ctx) {
    const now = Date.now();
