...
import { appendHistory, getLatestEntry, getHistory } from './history/historyStore.js';
import { agentHealthAnalyzer } from './analyzers/agentHealthAnalyzer.js';
import { squadEfficiencyAnalyzer } from './analyzers/squadEfficiencyAnalyzer.js';
import { endpointHealthAnalyzer } from './analyzers/endpointHealthAnalyzer.js';
import { envConsistencyAnalyzer } from './analyzers/envConsistencyAnalyzer.js';
import { repoIntegrityAnalyzer } from './analyzers/repoIntegrityAnalyzer.js';
import { graftAnalyzer } from './analyzers/graftAnalyzer.js';
import { swarmPatrolAnalyzer } from './analyzers/swarmPatrol.js';
import { reviveAgentStrategy } from './strategies/reviveAgentStrategy.js';
import { repairEndpointStrategy } from './strategies/repairEndpointStrategy.js';
import { envSyncStrategy } from './strategies/envSyncStrategy.js';
import { optimizeSquadStrategy } from './strategies/optimizeSquadStrategy.js';
import { codeQualityStrategy } from './strategies/codeQualityStrategy.js';
import { repairGraftStrategy } from './strategies/repairGraftStrategy.js';
import { updateTraitsFromEvent, computeResonanceSnapshot, saveResonanceInsights, getRecentInsights, } from "@dreamnet/memory-dna";
const STRATEGIES = [
    reviveAgentStrategy,
    ...
    async runCycle(trigger = "manual", context, mode = "full") {
        ...
        try {
            ...
            const cycle = {
                ...
                recommendations: [], // Mission 95: Adding empty recommendations for now
            };
            ...
            try {
                ...
                try {
                    const pheromoneModule = await import('./stores/pheromoneStore.js');
                    pheromoneStore = {
                ...
                try {
                    ...
                    try {
                        const swarmModule = await import('./analyzers/swarmPatrol.js');
                        swarmPatrol = {
                ...
                try {
                    ...
                    if (weakPoints.length > 0) {
                        const failureRate = weakPoints.filter(wp => wp.severity === "critical" || wp.severity === "error").length / Math.max(weakPoints.length, 1);
...
//# sourceMappingURL=haloEngine.js.map