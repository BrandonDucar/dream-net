...
export class DraftGenerator {
    ...
    async generateDraft(recipientEmail, options = {
        ...
        // Layer 1: Research
        const research = await researchEngine.researchRecipient(recipientEmail, recipientName, recipientCompany);
        // Layer 2: Relevance
        const topics = await relevanceEngine.findRelevantTopics(recipientEmail, recipientCompany, recipientCompany);
        // Layer 3: Geo Awareness
        const geoContext = await geoAwareness.getGeoContext(recipientEmail, recipientName, recipientCompany);
        // Generate subject line
        const subject = this.generateSubject(recipientName, recipientCompany, topics, research);
        // Generate body
        const body = this.generateBody(research, topics, geoContext, options, recipientName, recipientCompany);
     ...
     * Generate email body
     */
    generateBody(research, topics, geoContext, options, name, company) {
...
//# sourceMappingURL=draftGenerator.js.map