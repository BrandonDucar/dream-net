 ...
 */
// Export fibers
export { FIBERS, getAllFibers, isValidFiber } from './fibers.js';
// Export packets
export { createPacket, isValidPacket } from './packets.js';
// Export ports
export { createPort, isValidPort } from './ports.js';
// Export registry
...
// Export inspector
export { getPortsSnapshot, getRoutesSnapshot, getWormholesSnapshot } from './inspector.js';
// Export port IDs
export { PORT_IDS } from './port-ids.js';
// Import for default port registration
import { FIBERS } from './fibers.js';
import { createPort } from './ports.js';
