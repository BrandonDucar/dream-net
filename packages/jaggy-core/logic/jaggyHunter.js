 ...
 */
export async function huntWebhooks(territory) {
    const discoveries = [];
    const now = Date.now();
 ...
 */
export async function implementDiscovery(huntId) {
 ...
 */
export function watchMesh(event) {
    const discoveries = [];
 ...
 * Create territory
 */
export function createTerritory(name, type) {
    const territory = {
