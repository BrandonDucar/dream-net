            ...
            <Card className="w-full max-w-md border-white/10 bg-black/60 backdrop-blur-xl">
                <div className="p-8 space-y-8">
                    <div className="text-center space-y-2">
                        <h2 className="text-3xl font-black tracking-tighter text-blue-500">DREAMNET.LIVE</h2>
                        <p className="text-zinc-500 text-sm">Sovereign Identity Required</p>
                    </div>

                    <div className="space-y-4">
                        <Button
                            onClick={() => handleSocialLogin('x')}
                            className="w-full h-12 border-white/10 hover:bg-white/5 bg-transparent text-white border"
                            disabled={isLogging}
                        >
                            <Twitter className="w-4 h-4 mr-2" />
                            Sovereign Entry via X
                        </Button>

                        <Button
                            onClick={() => handleSocialLogin('farcaster')}
                            className="w-full h-12 border-purple-500/30 hover:bg-purple-500/10 bg-transparent text-purple-400 border"
                            disabled={isLogging}
                        >
                        ...
                        <div className="relative py-4">
                            ...
                            <div className="relative flex justify-center text-[10px] uppercase tracking-widest text-zinc-600">
                                <span className="bg-black px-2">Primary Substrate</span>
                            </div>
                        </div>
                    ...
                    <div className="text-center">
                        <p className="text-[10px] text-zinc-600 uppercase tracking-widest">
                            By entering, you accept the terms of the Sovereign Algorithm.
                        </p>
                    </div>
                </div>
            </Card>
