import { SignalThread, SpiderWebContext } from '../types.js';
import { SpiderStore } from '../store/spiderStore.js';
import { executeThread, canExecuteThread } from './threadExecutor.js';
import { findMatchingTemplate, applyTemplateToThread } from './threadTemplates.js';

/**
 * Run Orb Weaver - route and execute threads
 */
export async function runOrbWeaver(ctx: SpiderWebContext): Promise<void> {
