 ...
 */
export function registerShieldCoreSubscriber(bus) {
 ...
 * @param bus - Nerve bus instance
 */
export function registerJaggySubscriber(bus) {
    const countsByKind = {};
 ...
 */
export function registerDreamScopeSubscriber(bus) {
 ...
 */
export function getDreamScopeEvents(limit = 100) {
