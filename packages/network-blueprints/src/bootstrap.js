 ...
 */
import { registerCitizen, registerAgent, registerDream, registerPort, registerConduit, } from "../../directory/src/registry";
export function bootstrapFromBlueprint(blueprint) {
    const errors = [];
