 ...
 */
export const TRAVELNET_CORE_ID = "TRAVELNET_CORE";
export const TRAVELNET_PORT_ID = "travelnet-core"; // Matches PORT_IDS.TRAVELNET_CORE in @dreamnet/internal-ports
export const TRAVELNET_EVENT_TYPE = "travelnet.event";
export const TRAVELNET_FIBER = "GAMMA"; // Exploration/travel semantics

/**
 * DreamNet Core Constants
 */
export const DREAMNET_CORE_ID = "DREAMNET_CORE";
export const DREAMNET_PORT_ID = "dreamnet-core";
