import { DreamStateContext, DreamStateStatus } from '../types.js';
import { CitizenshipStore } from '../store/citizenshipStore.js';
import { ensureGovernmentDepartments } from '../logic/government.js';
import { ensureStateSymbols } from '../logic/government.js';
import { ensureDefaultDiplomaticRelations } from '../logic/diplomacy.js';
