...
export async function generateOrcaOutreachDraft(target, idea, theme, options) {
    ...
    try {
        const draft = await inboxSquared.generateDraft(target.email, draftOptions, target.name, target.organization || target.role);
...
//# sourceMappingURL=orcaOutreachCore.js.map