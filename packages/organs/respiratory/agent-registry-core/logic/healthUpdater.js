 ...
 */
export function refreshAgentScores(ctx) {
 ...
 */
export function recordAgentSuccess(agentId, latencyMs) {
...
export function recordAgentError(agentId, errorMessage) {
    const existing = AgentStore.getHealth(agentId);
    const now = Date.now();
    if (!existing)
        return;
...
//# sourceMappingURL=healthUpdater.js.map