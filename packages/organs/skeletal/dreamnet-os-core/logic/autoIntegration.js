 ...
 */
export function detectIntegrationGaps(ctx) {
    const gaps = [];
 ...
 */
export function autoFixIntegrationGaps(ctx) {
 ...
 * Get detected gaps
 */
export function getIntegrationGaps() {
    return detectedGaps;
}
//# sourceMappingURL=autoIntegration.js.map