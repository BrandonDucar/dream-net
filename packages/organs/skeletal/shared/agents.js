...
export function getAvailableAgents(trustScore, completedDreams, stakedSheep, hasTokenBoost = false) {
...
export function checkAgentAccess(agentKey, trustScore, completedDreams, stakedSheep, hasTokenBoost = false) {
...
export function getAgentDescription(agentKey) {
    const descriptions = {
