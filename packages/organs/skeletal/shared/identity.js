 ...
 */
export function authUserIdToIdentityId(authUserId) {
 ...
 */
export function ensureUserIdentity(authUserId, displayName, email) {
 ...
 */
export function linkIdentityToAgent(identityId, agentId, linkType = "controls") {
 ...
 */
export function getIdentityAgents(identityId) {
    if (!IdentityGrid)
        return []; // Identity Grid not available
 ...
 */
export function identityControlsAgent(identityId, agentId) {
    if (!IdentityGrid)
 ...
 */
export function createDreamNetContext(authUserId, displayName, email, meta) {
    const identityId = authUserIdToIdentityId(authUserId);
 ...
 */
export function getIdentityFromContext(ctx) {
 ...
 */
export function isValidDreamNetContext(ctx) {
    return (ctx &&
