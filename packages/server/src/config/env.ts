...
interface EnvConfig {
  ...
  // Integration API Keys & Hosts
  LENS_API_KEY?: string;
  FARCASTER_MNEMONIC?: string;
  MATRIX_HOMESERVER?: string;
  JELLYFIN_HOST?: string;
  PEERTUBE_HOST?: string;
  RESEARCHHUB_KEY?: string;
  OTP_HOST?: string;
  ...
  // Real World Sensors
  USE_REAL_SENSORS?: boolean;
  SATELLITE_API_KEY?: string;
  SATELLITE_API_ENDPOINT?: string;
...
function loadEnvConfig(): EnvConfig {
  ...
  return {
    ...
    // Real World Sensors (The "No Mock" Policy)
    USE_REAL_SENSORS: process.env.USE_REAL_SENSORS === 'true',
    SATELLITE_API_KEY: process.env.SATELLITE_API_KEY,
    SATELLITE_API_ENDPOINT: process.env.SATELLITE_API_ENDPOINT,
