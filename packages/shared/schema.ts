...
// import { createInsertSchema } from "drizzle-zod"; // Removed to fix z.int error
import { z } from "zod";
...
export const insertCocoonSchema = z.object({
  dreamId: z.string(),
  title: z.string(),
...
export const insertDreamCoreSchema = z.object({
  name: z.string(),
  type: z.enum(["resonance", "energy", "memory", "lucidity", "nightmare"]),
  ownerId: z.string(),
}) as unknown as z.ZodTypeAny;
...
export const insertCocoonLogSchema = z.object({
  cocoonId: z.string(),
...
export const insertEvolutionChainSchema = z.object({
  dreamId: z.string(),
  cocoonId: z.string().optional(),
  currentStage: z.string(),
  evolvedAt: z.date().optional(),
  completedAt: z.date().optional(),
  metadata: z.any().optional(),
}) as unknown as z.ZodTypeAny;

export const insertDreamInviteSchema = z.object({
  dreamId: z.string(),
  invitedWallet: z.string(),
  inviterWallet: z.string(),
  role: z.string(),
  message: z.string().optional(),
}) as unknown as z.ZodTypeAny;

export const insertDreamTokenSchema = z.object({
  dreamId: z.string(),
  cocoonId: z.string().optional(),
  holderWallet: z.string(),
  purpose: z.string(),
  milestone: z.string().optional(),
  metadata: z.any().optional(),
}) as unknown as z.ZodTypeAny;

export const insertSuperSpineAgentSchema = z.object({
  agentKey: z.string(),
  name: z.string(),
...
export const insertSuperSpineTaskSchema = z.object({
...
export const insertSuperSpineSubscriptionSchema = z.object({
  userId: z.string(),
  agentKey: z.string(),
  expiresAt: z.date(),
  price: z.any(),
...
export const insertOathSchema = z.object({
  userId: z.string(),
  username: z.string().optional(),
  evidenceUrl: z.string().optional(),
}) as unknown as z.ZodTypeAny;

export const insertHomeostasisBandSchema = z.object({
  userId: z.string(),
  band: z.enum(["green", "yellow", "red"]),
  pulseFrequency: z.number().int(),
}) as unknown as z.ZodTypeAny;
