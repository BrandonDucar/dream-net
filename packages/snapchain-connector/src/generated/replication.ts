...
import type { ReplicationServiceClient as _ReplicationServiceClient, ReplicationServiceDefinition as _ReplicationServiceDefinition } from './ReplicationService';
...
export interface ProtoGrpcType {
  ...
  FidAccountRootHash: MessageTypeDefinition
  FnameTransfer: MessageTypeDefinition
  FrameActionBody: MessageTypeDefinition
  FullProposal: MessageTypeDefinition
  GetShardSnapshotMetadataRequest: MessageTypeDefinition
  GetShardSnapshotMetadataResponse: MessageTypeDefinition
  GetShardTransactionsRequest: MessageTypeDefinition
  GetShardTransactionsResponse: MessageTypeDefinition
  ...
  ReplicationService: SubtypeConstructor<typeof grpc.Client, _ReplicationServiceClient> & { service: _ReplicationServiceDefinition }
  ReplicationTriePartStatus: MessageTypeDefinition
  ...
  ShardSnapshotMetadata: MessageTypeDefinition
  ShardTrieEntryWithMessage: MessageTypeDefinition
