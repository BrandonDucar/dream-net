 ...
 */
export function createHypha(sourceId, targetId, options) {
    const hypha = {
        id: nextHyphaId(),
        sourceId,
        targetId,
 ...
 */
export function createMycelium(name, neuronIds, hyphaIds) {
    const mycelium = {
        id: nextMyceliumId(),
        name,
        neurons: neuronIds,
 ...
 */
export function findOptimalPath(sourceId, targetId, myceliumId) {
 ...
 */
export function findAlternativePath(failedHyphaId, sourceId, targetId) {
 ...
 * Get all hyphae
 */
export function getHyphae() {
    return Array.from(hyphae.values());
}
/**
 * Get all mycelia
 */
export function getMycelia() {
    return Array.from(mycelia.values());
}
/**
 * Update hypha load
 */
export function updateHyphaLoad(hyphaId, load) {
