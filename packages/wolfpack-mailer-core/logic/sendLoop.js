...
import { getMaxEmailsPerCycle, getMaxEmailsPerDay, getRemainingToday, canSendMoreToday, incrementTodayCount, } from "./rateLimiter";
/**
 ...
 */
export async function processSendQueueOnce() {
    ...
    console.log(`[WolfPackMailer] Safety limits: max ${maxPerCycle} per cycle, ${remainingToday} remaining today (limit: ${getMaxEmailsPerDay()}/day)`);
    let sentCount = 0;
    let failedCount = 0;
