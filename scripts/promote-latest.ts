#!/usr/bin/env tsx
/**
 * Automatically Promote Latest Vercel Deployment to Production
...
async function main() {
  console.log("🚀 Promoting Latest Vercel Deployment to Production\n");
  ...
  if (!projectId) {
    ...
    console.log("💡 Make sure project is connected in Vercel dashboard");
    process.exit(1);
  }
