...
import { PatternRecognizer } from '../src/index';
import { ADULT_CONTENT_SIGNATURE, FRINGE_TECH_ADOPTION } from '../src/patterns/safety';
import { FinancialPatternEngine } from '../../wolfpack-analyst-core/src/FinancialPatternEngine';
