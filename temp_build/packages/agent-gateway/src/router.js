...
exports.resolveIntentToTool = resolveIntentToTool;
exports.isToolAllowedForCaller = isToolAllowedForCaller;
const tools_1 = require("./tools");
/**
 * Resolve intent string to a tool ID
 * Simple mapping for now; can get smarter later with NLP/LLM routing
 */
function resolveIntentToTool(body) {
    const { intent } = body;
 ...
 */
function isToolAllowedForCaller(toolId, req) {
    const cfg = (0, tools_1.getToolConfig)(toolId);
    if (!cfg)
