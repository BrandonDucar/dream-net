...
exports.getAgentWalletManager = getAgentWalletManager;
...
class AgentWalletManager {
    ...
    async createWallet(agentId, chain, label) {
        ...
        if (this.mnemonic) {
            ...
            const hdNode = ethers_1.HDNodeWallet.fromPhrase(this.mnemonic, undefined, "m");
...
function getAgentWalletManager(mnemonic) {
