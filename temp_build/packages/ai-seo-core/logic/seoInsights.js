...
exports.generateSEOInsights = generateSEOInsights;
...
function generateSEOInsights() {
    const insights = [];
    const optimizations = seoStore_1.SEOStore.listOptimizations();
    const keywords = seoStore_1.SEOStore.listKeywords();
    ...
    for (const insight of insights) {
        seoStore_1.SEOStore.addInsight(insight);
    }
    return insights;
}
