...
function routeRequest(request) {
    ...
    const scored = candidates.map((provider) => {
        const key = (0, keyManager_1.getBestKey)(provider.id);
        if (!key)
            return null;
