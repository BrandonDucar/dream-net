 ...
 */
export function ensureGovernmentDepartments(): GovernmentDepartment[] {
 ...
 */
export function recordGovernmentAction(
  type: GovernmentAction["type"],
  department: string,
  action: string,
  meta?: Record<string, any>
): GovernmentAction {
  const govAction: GovernmentAction = {
 ...
 */
export function ensureStateSymbols(): StateSymbol[] {
