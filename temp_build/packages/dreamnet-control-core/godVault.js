...
exports.GOD_VAULT = void 0;
exports.getGodVaultApiKeysFromEnv = getGodVaultApiKeysFromEnv;
exports.isGodVaultWallet = isGodVaultWallet;
/**
 ...
 */
function getGodVaultApiKeysFromEnv() {
    return exports.GOD_VAULT.internalApiKeyEnvVars
 ...
 */
function isGodVaultWallet(address) {
    if (!address)
        return false;
    const normalized = address.toLowerCase();
    return exports.GOD_VAULT.walletAddresses.includes(normalized);
}
