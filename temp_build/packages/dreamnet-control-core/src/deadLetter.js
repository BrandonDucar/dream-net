...
exports.addDeadLetterRecord = addDeadLetterRecord;
exports.getDeadLetterRecords = getDeadLetterRecords;
exports.getDeadLetterRecordsByConduit = getDeadLetterRecordsByConduit;
 ...
 */
function addDeadLetterRecord(params) {
    const record = {
        id: generateId(),
        ...params,
 ...
 */
function getDeadLetterRecords(limit) {
 ...
 */
function getDeadLetterRecordsByConduit(conduitId) {
