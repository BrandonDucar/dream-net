...
exports.getEffectiveRateLimit = getEffectiveRateLimit;
/**
 ...
 */
function tierHasFeature(tierId, featureFlag) {
 ...
 */
function getEffectiveRateLimit(tierId, clusterLimit) {
