...
exports.feedCostMetricsToWolfPack = feedCostMetricsToWolfPack;
exports.feedPerformanceMetricsToWhalePack = feedPerformanceMetricsToWhalePack;
exports.feedSocialMetricsToOrcaPack = feedSocialMetricsToOrcaPack;
exports.feedHealthMetricsToPacks = feedHealthMetricsToPacks;
/**
 * Feed cost metrics to Wolf Pack (funding decisions)
 */
function feedCostMetricsToWolfPack(costSummary) {
 ...
 */
function feedPerformanceMetricsToWhalePack(metrics) {
    const signal = {
 ...
 */
function feedSocialMetricsToOrcaPack(metrics) {
    const signal = {
        type: "social_metric",
        clusterId: metrics.clusterId,
 ...
 */
function feedHealthMetricsToPacks(health) {
    const signal = {
        type: "health_metric",
