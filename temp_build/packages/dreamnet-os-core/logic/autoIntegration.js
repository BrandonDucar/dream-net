...
exports.detectIntegrationGaps = detectIntegrationGaps;
exports.autoFixIntegrationGaps = autoFixIntegrationGaps;
exports.getIntegrationGaps = getIntegrationGaps;
let detectedGaps = [];
/**
 * Detect integration gaps
 */
function detectIntegrationGaps(ctx) {
    const gaps = [];
 ...
 */
function autoFixIntegrationGaps(ctx) {
