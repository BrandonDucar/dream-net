...
exports.EconStore = {
    ...
    adjustBalance(identityId, token, delta) {
        const existing = exports.EconStore.getBalance(identityId, token);
        const newAmount = existing.amount + delta;
        return exports.EconStore.setBalance(identityId, token, newAmount);
    },
    listBalances() {
    ...
    status() {
        const sampleBalances = exports.EconStore.listBalances().slice(0, 25);
        return {
            lastRunAt,
