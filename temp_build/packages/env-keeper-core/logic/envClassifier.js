...
exports.classifyEnvVar = classifyEnvVar;
exports.createEnvVarDescriptor = createEnvVarDescriptor;
exports.updateEnvRegistry = updateEnvRegistry;
exports.getEnvDescriptor = getEnvDescriptor;
exports.getDescriptorsBySensitivity = getDescriptorsBySensitivity;
/**
 * Secret key patterns
 */
 ...
 */
function classifyEnvVar(key, value) {
 ...
 */
function createEnvVarDescriptor(key, value, source = "process") {
 ...
 */
function updateEnvRegistry(descriptor) {
 ...
 */
function getDescriptorsBySensitivity(sensitivity) {
    const { ENV_REGISTRY } = require("../types");
