...
exports.quorumEngine = exports.QuorumEngine = void 0;
exports.checkTechQuorum = checkTechQuorum;
exports.checkCreatorQuorum = checkCreatorQuorum;
exports.checkSafetyQuorum = checkSafetyQuorum;
const quorumStore = {};
class QuorumEngine {
    decisions = new Map();
    /**
...
exports.QuorumEngine = QuorumEngine;
exports.quorumEngine = new QuorumEngine();
/**
 * Tech Quorum: Agents + automated tests
 */
async function checkTechQuorum(policyId, testResults, agentVotes) {
 ...
 */
function checkCreatorQuorum(votes, threshold) {
 ...
 */
function checkSafetyQuorum(votes, requireUnanimous = false) {
    if (votes.length === 0)
        return false;
