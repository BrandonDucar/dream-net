...
exports.getAllFibers = getAllFibers;
...
exports.FIBERS = {
    ...
    OMEGA: 'omega',
    /**
     * EPSILON - Research and science channel
     * Used for Archimedes and experimental communications
     */
    EPSILON: 'epsilon'
};
/**
...
function getAllFibers() {
    return Object.values(exports.FIBERS);
}
/**
 * Check if a string is a valid fiber channel
 */
function isValidFiber(fiber) {
    return Object.values(exports.FIBERS).includes(fiber);
}
