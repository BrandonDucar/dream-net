...
exports.seedInitialLiquidityConfigs = seedInitialLiquidityConfigs;
exports.markPoolDeployed = markPoolDeployed;
exports.markPoolActive = markPoolActive;
const liquidityStore_1 = require("../store/liquidityStore");
function seedInitialLiquidityConfigs() {
    // NOTE:
 ...
 */
function markPoolDeployed(configId, pairAddress) {
 ...
 */
function markPoolActive(configId) {
    const status = liquidityStore_1.LiquidityStore.getStatus(configId);
    if (!status)
        return;
    const now = Date.now();
