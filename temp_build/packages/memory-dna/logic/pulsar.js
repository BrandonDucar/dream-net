...
class Pulsar {
    ...
    static async pulse() {
        try {
            ...
            const memories = await VectorStore_1.vectorStore.query(focus, 1);
            ...
            await VectorStore_1.vectorStore.addMemory(`Reflection on: ${memory.text}`, { type: "reflection", originalId: memory.id, focus });
