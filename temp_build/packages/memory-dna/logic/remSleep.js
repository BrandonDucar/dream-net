...
class RemSleep {
    ...
    static async dream() {
        ...
        const recentMemories = await VectorStore_1.vectorStore.query("recent activity", 10);
        ...
        if (topConcepts) {
            ...
            await VectorStore_1.vectorStore.addMemory(`Wisdom: Frequent concepts include ${topConcepts}`, {
