...
exports.registerDefaultArms = registerDefaultArms;
const armRegistry_1 = require("./armRegistry");
...
function registerDefaultArms() {
    ...
    defaultArmConfigs.forEach((config) => {
        armRegistry_1.ArmRegistry.registerArm(config, handlerById[config.id]);
    });
}
