...
function recomputeReputation(now) {
    const cfg = reputationStore_1.ReputationStore.getConfig();
    const allSignals = reputationStore_1.ReputationStore.getSignals();
    ...
    for (const [key, entitySignals] of byEntity.entries()) {
        ...
        reputationStore_1.ReputationStore.upsertScore(rep);
    }
}
