...
exports.learnFromThreats = learnFromThreats;
exports.predictThreatSeverity = predictThreatSeverity;
exports.getThreatPatterns = getThreatPatterns;
exports.getThreatPattern = getThreatPattern;
const shieldStore_1 = require("../store/shieldStore");
const threatPatterns = new Map();
/**
 * Learn from threats and update patterns
 */
function learnFromThreats() {
    const allThreats = shieldStore_1.ShieldStore.listThreats();
    const newPatterns = [];
 ...
 */
function predictThreatSeverity(threat) {
 ...
 */
function getThreatPattern(type, level) {
