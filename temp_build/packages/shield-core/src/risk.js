...
exports.listRiskProfiles = listRiskProfiles;
exports.getRiskProfilesByLevel = getRiskProfilesByLevel;
const profiles = new Map();
function getRiskProfile(callerId) {
...
function updateRiskProfile(params) {
...
function listRiskProfiles() {
    return Array.from(profiles.values());
}
function getRiskProfilesByLevel(level) {
