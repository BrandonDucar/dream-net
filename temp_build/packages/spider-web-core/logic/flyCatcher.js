...
exports.shouldFlyStick = shouldFlyStick;
exports.classifyFly = classifyFly;
exports.catchFly = catchFly;
exports.createFly = createFly;
...
function catchFly(fly) {
    ...
    // Store fly
    spiderStore_1.SpiderStore.catchFly(fly);
    // Classify fly
    ...
    spiderStore_1.SpiderStore.markFlyProcessed(fly.id, threadId);
 ...
 */
function createFly(type, source, payload, priority = "medium", sticky = false) {
    const now = Date.now();
    const id = nextFlyId();
    return {
        id,
