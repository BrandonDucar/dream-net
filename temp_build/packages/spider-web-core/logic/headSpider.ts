...
function node(kind: SpiderNodeRef["kind"], id: string, label?: string): SpiderNodeRef {
  return { kind, id, label };
}

export function runHeadSpider(ctx: SpiderWebContext): SignalThread[] {
