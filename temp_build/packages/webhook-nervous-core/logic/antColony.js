...
exports.createPheromoneTrail = createPheromoneTrail;
exports.createAnt = createAnt;
exports.findBestTrail = findBestTrail;
exports.followTrail = followTrail;
exports.completeAnt = completeAnt;
exports.evaporateTrails = evaporateTrails;
exports.getPheromoneTrails = getPheromoneTrails;
exports.getActiveAnts = getActiveAnts;
exports.getStuckAnts = getStuckAnts;
exports.markAntStuck = markAntStuck;
 ...
 */
function createPheromoneTrail(path, successRate = 1.0, latency = 0) {
    const trail = {
        id: nextTrailId(),
        path,
        strength: 1.0,
 ...
 */
function createAnt(requestId, payload, destination) {
    const ant = {
        id: nextAntId(),
        requestId,
        payload,
 ...
 */
function findBestTrail(destination) {
 ...
 */
function followTrail(antId, trailId) {
 ...
 */
function completeAnt(antId, success, latency) {
    const ant = activeAnts.get(antId);
    if (!ant)
        return;
 ...
 */
function getStuckAnts(timeoutMs = 30000) {
    const now = Date.now();
