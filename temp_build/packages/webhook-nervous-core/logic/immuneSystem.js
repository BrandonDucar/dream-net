...
exports.createAntibody = createAntibody;
exports.detectAntigens = detectAntigens;
exports.neutralizeAntigen = neutralizeAntigen;
exports.getAntigens = getAntigens;
exports.getAntibodies = getAntibodies;
exports.getMemoryCells = getMemoryCells;
exports.decayMemoryCells = decayMemoryCells;
 ...
 */
function createAntibody(name, pattern, action, options) {
    const antibody = {
        id: nextAntibodyId(),
        name,
        pattern,
 ...
 */
function neutralizeAntigen(antigenId) {
