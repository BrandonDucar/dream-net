...
exports.createNeuron = createNeuron;
exports.createSynapse = createSynapse;
exports.fireNeuron = fireNeuron;
exports.createReflexArc = createReflexArc;
exports.checkReflexArcs = checkReflexArcs;
exports.getNeurons = getNeurons;
exports.getSynapses = getSynapses;
exports.getReflexArcs = getReflexArcs;
exports.getNeuron = getNeuron;
exports.healNeurons = healNeurons;
let neurons = new Map();
 ...
 */
function createNeuron(name, url, type, options) {
    const now = Date.now();
    const neuron = {
        id: nextNeuronId(),
        name,
 ...
 */
function createSynapse(sourceNeuronId, targetNeuronId, type = "excitatory", strength = 0.5) {
 ...
 */
async function fireNeuron(neuronId, payload, options) {
 ...
 */
function createReflexArc(name, trigger, response, priority = "medium") {
    const reflex = {
        id: `reflex:${Date.now()}`,
        name,
        trigger,
 ...
 */
function checkReflexArcs(event) {
    const triggered = [];
