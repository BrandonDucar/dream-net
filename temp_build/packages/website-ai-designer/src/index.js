...
exports.WebsiteAIDesigner = void 0;
exports.getWebsiteDesigner = getWebsiteDesigner;
const openai_1 = __importDefault(require("openai"));
class WebsiteAIDesigner {
    openai = null;
    gptId;
    constructor(gptId) {
...
exports.WebsiteAIDesigner = WebsiteAIDesigner;
// Export singleton instance
let designerInstance = null;
function getWebsiteDesigner() {
    if (!designerInstance) {
        designerInstance = new WebsiteAIDesigner();
    }
    return designerInstance;
}
exports.default = WebsiteAIDesigner;
