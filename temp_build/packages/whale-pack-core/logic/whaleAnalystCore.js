...
exports.runWhaleAnalysis = runWhaleAnalysis;
...
function runWhaleAnalysis(ctx) {
    ...
    for (const [productId, count] of Object.entries(planCountsByProduct)) {
        if (count >= 3) {
            ...
            whaleStore_1.WhaleStore.addInsight(insight);
