...
exports.runWolfPackAnalystCycle = runWolfPackAnalystCycle;
const analystStore_1 = require("../store/analystStore");
const patternTrainer_1 = require("../logic/patternTrainer");
const insightEngine_1 = require("../logic/insightEngine");
/**
 ...
 */
function runWolfPackAnalystCycle(ctx) {
    const now = Date.now();
    ...
    const leadPatterns = (0, patternTrainer_1.trainOnLeadScoring)(leads);
    ...
    const emailPatterns = (0, patternTrainer_1.trainOnEmailEffectiveness)(queueItems, leads);
    ...
    const insights = (0, insightEngine_1.generateInsights)(leads, queueItems, allPatterns);
    console.log(`[WolfPackAnalyst] Generated ${insights.length} insights`);
    // 3. Generate predictions
    console.log("[WolfPackAnalyst] Generating predictions...");
    const predictions = (0, insightEngine_1.generatePredictions)(leads, allPatterns);
    ...
    const emailAnalyses = (0, insightEngine_1.analyzeEmailEffectiveness)(queueItems, leads);
    ...
    analystStore_1.AnalystStore.incrementTrainingCycles();
    analystStore_1.AnalystStore.setLastRunAt(now);
    const status = analystStore_1.AnalystStore.status();
