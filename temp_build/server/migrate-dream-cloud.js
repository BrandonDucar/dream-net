...
exports.migrateDreamCloud = migrateDreamCloud;
function migrateDreamCloud() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            try {
                ...
                return [2 /*return*/, { success: true, message: 'Migration completed successfully' }];
            }
            catch (error) {
...
if (typeof process !== 'undefined' && import.meta.url === "file://".concat(process.argv[1])) {
    migrateDreamCloud().then(function (result) {
