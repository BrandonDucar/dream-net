...
exports.DreamKeeperAgent = void 0;
var DreamKeeperAgent = /** @class */ (function () {
    function DreamKeeperAgent() {
        this.id = 'dreamnet-dreamkeeper';
        this.name = 'DreamKeeper';
        this.description = 'Global diagnostic and health-scoring agent for DreamNet';
        this.category = 'monitoring';
        this.version = '1.0.0';
    }
    DreamKeeperAgent.prototype.initialize = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        console.error('Failed to initialize DreamKeeper:', error_1);
                        return [3 /*break*/, 4];
    ...
    DreamKeeperAgent.prototype.run = function (input, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        prompt = "Analyze this DreamNet state and generate a dreamkeeper_update:\n\nSnapshot ID: ".concat(input.snapshotId, "\nTimestamp: ").concat(input.timestamp, "\n\nVertex Fusion:\n").concat(JSON.stringify(input.vertexFusion, null, 2), "\n\nDome State:\n").concat(JSON.stringify(input.domeState, null, 2), "\n\nAgent Metrics:\n").concat(JSON.stringify(input.agentMetrics, null, 2), "\n\nAnomalies:\n").concat(JSON.stringify(input.anomalies, null, 2), "\n\nOutput ONLY a JSON object with this structure:\n{\n  \"overallHealth\": \"STABLE|WARN|CRITICAL\",\n  \"scores\": {\n    \"core\": 0-100,\n    \"dome\": 0-100,\n    \"hubs\": 0-100,\n    \"realms\": 0-100,\n    \"infra\": 0-100,\n    \"agents\": 0-100\n  },\n  \"alerts\": [\n    {\n      \"id\": \"alert-1\",\n      \"severity\": \"INFO|WARN|CRITICAL\",\n      \"area\": \"CORE|DOME|HUBS|REALMS|INFRA|AGENTS\",\n      \"description\": \"string\",\n      \"suggestedHandler\": \"drone-dome-sky-scanner|nightmare-surgeon|dev-cookbox\"\n    }\n  ],\n  \"tasks\": [\n    {\n      \"id\": \"task-1\",\n      \"handlerAgentId\": \"string\",\n      \"taskType\": \"string\",\n      \"payload\": {},\n      \"priority\": \"LOW|MEDIUM|HIGH\"\n    }\n  ]\n}");
    ...
    return DreamKeeperAgent;
}());
exports.DreamKeeperAgent = DreamKeeperAgent;
