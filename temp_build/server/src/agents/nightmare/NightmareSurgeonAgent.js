...
exports.NightmareSurgeonAgent = void 0;
var NightmareSurgeonAgent = /** @class */ (function () {
    function NightmareSurgeonAgent() {
        this.id = 'nightmare-surgeon';
        this.name = 'Nightmare Surgeon';
        this.description = 'Plans remediation sequences for anomalies and infected dreams within DreamNet';
        this.category = 'action';
        this.version = '1.0.0';
    }
    NightmareSurgeonAgent.prototype.initialize = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        console.error('Failed to initialize Nightmare Surgeon:', error_1);
                        return [3 /*break*/, 4];
    ...
    NightmareSurgeonAgent.prototype.run = function (input, ctx) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return NightmareSurgeonAgent;
}());
exports.NightmareSurgeonAgent = NightmareSurgeonAgent;
