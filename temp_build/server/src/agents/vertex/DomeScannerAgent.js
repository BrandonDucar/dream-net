...
exports.DomeScannerAgent = void 0;
var DomeScannerAgent = /** @class */ (function () {
    function DomeScannerAgent() {
        this.id = 'drone-dome-sky-scanner';
        this.name = 'Drone Dome Sky Scanner';
        this.description = 'Analyzes vertex_fusion and generates dome control actions';
        this.category = 'analysis';
        this.version = '1.0.0';
    }
    DomeScannerAgent.prototype.initialize = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        console.error('Failed to initialize Dome Scanner:', error_1);
                        return [3 /*break*/, 4];
    ...
    DomeScannerAgent.prototype.run = function (vertexFusion, ctx) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return DomeScannerAgent;
}());
exports.DomeScannerAgent = DomeScannerAgent;
var DomeScannerAgent = /** @class */ (function () {
    function DomeScannerAgent() {
        this.id = 'dome-scanner';
        this.name = 'Drone Dome Sky Scanner';
        this.description = 'Analyzes vertex_fusion and generates dome control actions';
        this.category = 'analysis';
        this.version = '1.0.0';
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        console.error('Failed to initialize Dome Scanner:', error_2);
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
                }
            });
    ...
    DomeScannerAgent.prototype.healthCheck = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!this.model) {
