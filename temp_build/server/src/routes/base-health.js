...
router.get("/", function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        try {
            baseHealth = dreamkeeperCore_1.DREAMKEEPER_CORE.baseHealth;
            res.json({
                success: true,
                networks: {
...
router.post("/check", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var network, networkType, result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                network = req.body.network;
                networkType = network === 'sepolia' ? 'sepolia' : 'mainnet';
                return [4 /*yield*/, dreamkeeperCore_1.DREAMKEEPER_CORE.checkBaseHealth(networkType)];
            case 1:
                result = _a.sent();
                res.json({
                    success: true,
