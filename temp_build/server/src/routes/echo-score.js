...
router.get('/:wallet', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var log, wallet, isProduction, score, trustLevel, unlockedAgents, echoAnalysis, log_1;
    return __generator(this, function (_a) {
        ...
        try {
            ...
            log_1.error('ECHO scoring error', error instanceof Error ? error : new Error(String(error)));
