...
var conduitMetrics_1 = require("../../packages/dreamnet-control-core/src/conduitMetrics");
 ...
 */
router.get("/grid/lines", (0, withPort_1.withPort)("AGENT_GATEWAY"), (0, controlCoreMiddleware_1.withGovernance)({ clusterId: "CIVIC_PANEL_CORE", requiredOfficeIds: ["FOUNDER"] }), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var r, traceId, metrics;
    return __generator(this, function (_a) {
        try {
            r = req;
            traceId = r.traceId || "unknown";
            metrics = (0, conduitMetrics_1.computeConduitMetrics)();
