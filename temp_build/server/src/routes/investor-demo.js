...
exports.investorDemoRouter = void 0;
var express_1 = require("express");
var sweet_spot_guard_1 = require("../middleware/sweet-spot-guard");
var router = (0, express_1.Router)();
exports.investorDemoRouter = router;
// Get live Sweet Spot metrics for investor demonstration
router.get('/api/investor-demo/sweet-spot-metrics', function (req, res) {
    try {
        var currentMetrics = {
            agents: 24,
            connections: 32,
        ...
        var validation = sweet_spot_guard_1.SweetSpotGuard.validate(currentMetrics);
        res.json({
            success: true,
...
router.get('/api/investor-demo/legal-protection', function (req, res) {
    try {
        var legalStatus = {
...
router.get('/api/investor-demo/technical-architecture', function (req, res) {
    try {
        var architecture = {
...
router.get('/api/investor-demo/funding-readiness', function (req, res) {
    try {
        var fundingData = {
