...
function handler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, dreamId, reward, note, wallet, bounty;
        return __generator(this, function (_b) {
            if (req.method !== 'POST')
                return [2 /*return*/, res.status(405).end()];
            _a = req.body, dreamId = _a.dreamId, reward = _a.reward, note = _a.note, wallet = _a.wallet;
            bounty = {
                dreamId: dreamId,
                reward: reward,
                note: note,
            ...
            try {
                ...
                console.log("Dream ".concat(dreamId, " marked with active bounty"));
                res.json({ success: true, bounty: bounty });
            }
            catch (error) {
