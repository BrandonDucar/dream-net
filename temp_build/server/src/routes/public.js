...
function createPublicRouter() {
    ...
    router.get("/public/status", function (_req, res) { return __awaiter(_this, void 0, void 0, function () {
        var now, metrics, status_1, error_1;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (cachedStatus && now - cachedStatus.timestamp < CACHE_TTL_MS) {
                        return [2 /*return*/, res.json(__assign({ ok: true }, cachedStatus.data))];
                    }
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error("Failed to get public status:", error_1);
