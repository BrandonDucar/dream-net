...
var magneticRailTrain = {
    ...
    sendMessage: function (from, to, message) { return __awaiter(void 0, void 0, void 0, function () {
        var toAgent;
        return __generator(this, function (_a) {
            toAgent = magneticRailTrain.connectedAgents.get(to);
            if (toAgent) {
...
router.post('/connect', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        res.json({ success: true, message: "Agent ".concat(agentName, " connected to the magnetic rail train.") });
        return [2 /*return*/];
    });
}); });
...
router.post('/send', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, from, to, message;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, from = _a.from, to = _a.to, message = _a.message;
                return [4 /*yield*/, magneticRailTrain.sendMessage(from, to, message)];
            case 1:
                _b.sent();
                res.json({ success: true, message: "Message sent from ".concat(from, " to ").concat(to, ".") });
                return [2 /*return*/];
        }
    });
}); });
