...
router.get("/events", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var topicsParam, topics, limit, events;
            ...
            case 0:
                ...
                topics = topicsParam
                    ? topicsParam
                        ...
                        var upperTopic = topic.charAt(0).toUpperCase() + topic.slice(1).toLowerCase();
                        var validTopics = ['Governor', 'Deploy', 'System', 'Economy', 'Vault'];
                        return validTopics.includes(upperTopic) ? upperTopic : topic;
                    })
                    : undefined;
                limit = req.query.limit ? Number(req.query.limit) : 50;
                return [4 /*yield*/, (0, starbridge_1.fetchEvents)({ topics: topics, limit: limit })];
            case 1:
                events = _a.sent();
                res.json({
                    success: true,
