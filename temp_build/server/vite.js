...
function setupVite(app, server) {
    return __awaiter(this, void 0, void 0, function () {
        var viteConfigPath, viteModule, viteConfig, serverOptions, vite;
        var _this = this;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    viteConfigPath = path_1.default.resolve(process.cwd(), "vite.config.ts");
                    if (!fs_1.default.existsSync(viteConfigPath)) {
                        log("Skipping Vite middleware; missing ".concat(viteConfigPath), "vite");
                        return [2 /*return*/];
                    }
                    return [4 /*yield*/, Promise.resolve("".concat((0, url_1.pathToFileURL)(viteConfigPath).href)).then(function (s) { return require(s); })];
                case 1:
                    viteModule = (_b.sent());
                    viteConfig = (_a = viteModule.default) !== null && _a !== void 0 ? _a : viteModule;
                    serverOptions = {
                        middlewareMode: true,
                        hmr: { server: server },
                        allowedHosts: true,
                    };
                    return [4 /*yield*/, (0, vite_1.createServer)(__assign(__assign({}, viteConfig), { configFile: false, customLogger: __assign(__assign({}, viteLogger), { error: function (msg, options) {
                    ...
                    app.use("*", function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    _a.trys.push([1, 4, , 5]);
                                    clientTemplate = path_1.default.resolve(process.cwd(), "client", "index.html");
                                    if (!fs_1.default.existsSync(clientTemplate)) {
                                        throw new Error("Client template missing at ".concat(clientTemplate));
                                    }
...
function serveStatic(app) {
    ...
    var distPath = path_1.default.resolve(process.cwd(), "client", "dist");
    // Fallback to server/public if client/dist doesn't exist
    var fallbackPath = path_1.default.resolve(process.cwd(), "server", "public");
    var staticPath = fs_1.default.existsSync(distPath) ? distPath : fallbackPath;
    if (!fs_1.default.existsSync(staticPath)) {
        log("Warning: Static directory not found at ".concat(staticPath, ", serving API only"), "vite");
        return;
    }
    log("Serving static files from ".concat(staticPath), "vite");
