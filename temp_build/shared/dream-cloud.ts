export interface DreamCloud {
  id: string;
  name: string; // e.g. "DeFi", "ZK Security", "Memes", "Gaming"
  description: string;
  themeColor: string;
  icon: string;
  dreams: string[]; // dream IDs
  remixXP: number;
  nodeAffinity?: string[]; // optional node tie-ins like Flutterbye
  activeAgents: string[];
